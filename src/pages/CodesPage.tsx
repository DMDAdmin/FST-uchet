...
export function CodesPage() {
  ...
  return (
    <div className="flex flex-col gap-4 p-5">
      <header>
        <h2 className="text-xl font-bold text-ink">{t('codes.title')}</h2>
        <p className="text-sm text-ink-muted">{t('codes.subtitle')}</p>
      </header>
      ...
      <div className="rounded-xl border border-grid bg-white p-4 text-sm text-stone-600">
